...
<%
    ...
    String sName = req("S_Name", request);
    int nextSort = 0; // 預設值
...
<%
    ...
    if (isPost(request)){
        ...
        sqlMax = "SELECT TOP 1 S_Sort FROM Friend_Star ORDER BY S_Sort DESC";
        rsMax = stmtMax.executeQuery(sqlMax);
        if (rsMax.next()) {
            // 拿到目前最大的號碼，然後 +1
            nextSort = rsMax.getInt("S_Sort") + 1;
        }
        
        sqlInsert = "INSERT INTO Friend_Star (S_Name, S_Sort) VALUES (?, ?)";
        ...
        <form method="post" action="TypeList_Edit.jsp" name="TypeAdd">
            <table border="1">
                ...
                <td colspan="2" align="center">
                    ...
                    <input type="button" value="返回" onclick="location.href='FriendStar_List.jsp';">
                </td>
            </table>
        </form>
    </body>
