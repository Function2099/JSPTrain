...
<html>
    ...
    <body>
        ????<%= OrgName %>
        <h1>?????</h1>
        <a href="Friend_List.jsp" target="frmBody" >?????</a><br>
        <div class="sub-menu">
            <%= TypeLinks %>
        </div>
        <a href="Friend_Edit.jsp" target="frmBody" >?????</a><br>
        <a href="FriendType_List.jsp" target="frmBody" >????</a><br>
        <a href="FriendStar_List.jsp" target="frmBody" >????</a><br>
        <a href="FriendHobby_List.jsp" target="frmBody" >????</a><br>
        <a href="FriendTitle_List.jsp" target="frmBody" >????</a><br>
    </body>
    <%= ScriptStr%>
</html>
